...
import Hilos_CLiente.Servidor_hilo;
import chat.ChatInterfaz;


public class Servidor extends JFrame {
	/**
	 * @author Santy, Franco, Boty
	 */
	...
	private void createGUI() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(ChatInterfaz.class.getResource("/imagenes/ch.png")));
